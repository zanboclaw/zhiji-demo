...
export const capabilities = [
  {
    icon: Brain,
    title: '仿真编排',
    description: '把自然语言、视觉目标和动作约束整理成可执行行为树。',
...
export const pricingPlans = [
  {
    ...
    tag: '基础版',
    price: '联系咨询',
    desc: '适合个人开发者和小型项目组，快速使用任务编排、仿真验证与基础部署能力。',
    points: ['基础行为编排与行为树生成', '标准仿真工作台与验证流程', '单团队空间与基础权限配置', '适合小规模场景配置与流程验证'],
  ...
  },
  {
    ...
    tag: '团队版',
    price: '按席位 / 机器人规模',
    desc: '面向正式研发团队，覆盖多成员协作、技能复用、版本管理与多机器人验证。',
  ...
  },
  {
    ...
    tag: '企业版',
    price: '定制报价',
    desc: '支持私有化部署、行业集成与大规模机队控制，适合对安全、权限和系统对接要求更高的组织。',
...
export const partnershipTracks = [
  {
    title: '硬件适配',
    desc: '面向机器人本体、传感器、控制器与边缘硬件，统一能力接口和运行方式。',
    points: ['适配本体、传感器与控制器', '统一接口与接入规范', '支持不同硬件组合快速联调'],
    icon: Building2,
  },
  {
    title: '行业集成',
    desc: '适配园区、仓储、安防和制造等场景的业务流程与系统要求。',
    points: ['对接行业业务系统', '支持典型场景快速配置', '减少重复开发成本'],
    icon: Handshake,
  },
  {
    title: '场景配置',
    desc: '围绕重点场景梳理任务流程、验证标准和部署配置，形成可复用模板。',
    points: ['梳理场景流程与执行边界', '沉淀可复用任务模板', '形成标准化交付方法'],
    icon: Briefcase,
  },
]

export const consultTopics = ['产品功能', '部署咨询', '私有化部署', '生态适配']

export const promptText = '帮我给安防巡逻机器人生成夜间巡检策略，发现异常就拍照并通知值班室'
export const aiMessage = '已生成夜间巡检任务流程，包含路线巡检、异常检测、告警上报与返航待命四段逻辑。你可以继续补充区域限制、告警方式或巡检频次，我会同步更新行为树。'
